<template>
    <div class="card-list">
        ...
        <a href="#" class="card-item">
            <img src="../../assets/produtos/processador.jpg" alt="Card Image">
